...
def run_comparison():
    ...
    Returns:
        pandas.DataFrame with columns 'original_formula', 'new_formula',
        'our_distance_Da', and 'envemind_distance_Da', one row per
        protein where Envemind succeeded; proteins that raised an
...
def _plot(df):
    """
    Plot and save histograms for both methods.
    """
